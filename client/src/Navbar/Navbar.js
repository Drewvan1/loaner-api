...
class Navbar extends Component {
	...
	renderContent () {
		...
		const logoutJSX = (
			<div className={'flex-grow pa3 flex items-center'}>
				...
				<div className={'f6 link dib white dim mr3 mr4-ns'} href="/test">
					{this.props.user.name}
				</div>
				<Link
					className={'f6 link dib white dim mr3 mr4-ns br-pill b--white-20 ba pv2 ph4'}
					to="/reservations/new"
				>
					Reserve Loaner
				</Link>
	...
	render () {
		return (
			<nav className={'flex justify-between bb b--white-10 bg-dark-blue shadow-2'}>{this.renderContent()}</nav>
		);
	}
}
