...
class Navbar extends Component {
    ...
    render(){
        return(
            <nav class={"flex justify-between bb b--white-10 bg-dark-blue"}>
                ...
                <div class={"flex-grow pa3 flex items-center"}>
                    <a class={"f6 link dib white dim mr3 mr4-ns"} href="/test">Test</a>
                    <a class={"f6 link dib white dim mr3 mr4-ns"} href="/api/reservations/new">Reserve Loaner</a>
                    <a class={"f6 dib white bg-animate hover-bg-white hover-black no-underline pv2 ph4 br-pill ba b--white-20"} href="/auth/google">Sign In With Google</a>
                </div>
            </nav>
        )
    }
